...
class BootstrapDefault
{
    ...
    public function initAssets()
    {
        ...
        addJavascriptFile('assets/metronic-8/js/custom/widgets.js');
        addJavascriptFile('assets/metronic-8/js/custom/apps/chat/chat.js');
        addJavascriptFile('assets/metronic-8/js/custom/utilities/modals/upgrade-plan.js');
        addJavascriptFile('assets/metronic-8/js/custom/utilities/modals/create-app.js');
        addJavascriptFile('assets/metronic-8/js/custom/utilities/modals/users-search.js');
        addJavascriptFile('assets/metronic-8/js/custom/utilities/modals/new-target.js');
    }
